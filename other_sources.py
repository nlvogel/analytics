            ...
            'reportRequests': [
                {
                    ...
                    'dimensions': [{'name': 'ga:segment'}, {'name': 'ga:adContent'}, {'name': 'ga:source'}],
                            ...
                            'filters': [
                                {
                                    ...
                                    'operator': 'REGEXP',
                                    'expressions': "listing|zboost|gmb"
                                },
                                {
    ...
    for report in response.get('reports', []):
        ...
        try:
            for row in rows:
                ...
                if row.get('dimensions')[2] == 'zillow' and data_list[3] == 'listing':
                    data_list[3] = 'Zillow Listing'
                elif data_list[3].startswith('zboost'):
                    data_list[3] = 'Zillow Boost'
                elif row.get('dimensions')[2] == 'bdx':
                    data_list[3] = 'BDX Listing'
                elif data_list[3] == 'gmb':
                    data_list[3] = 'Google Business Profile'
                elif row.get('dimensions')[2] == 'newhomesource.com' and data_list[3] == 'listing':
                    data_list[3] = 'New Home Source'
                # sheets.append_sheet([data_list], SHEET, 'Other Sources!A2')
                with open(f'{now}-other_sources.csv', mode='a') as f:
                    writer = csv.writer(f)
